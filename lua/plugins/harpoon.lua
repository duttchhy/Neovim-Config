...
-- Alternative
      { "ha", function() harpoon:list():add() end, desc = "Add file" },
      { "hm", function() harpoon.ui:toggle_quick_menu(harpoon:list()) end, desc = "Menu" },
      { "h1", function() harpoon:list():select(1) end, desc = "Go to file 1" },
      { "h2", function() harpoon:list():select(2) end, desc = "Go to file 2" },
      { "h3", function() harpoon:list():select(3) end, desc = "Go to file 3" },
      { "h4", function() harpoon:list():select(4) end, desc = "Go to file 4" },
    } 
