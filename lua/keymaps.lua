...
keymap("n", "<Leader>1", "1gt", vim.tbl_extend("force", opts, { desc = "Go to tab 1" }))
keymap("n", "<Leader>2", "2gt", vim.tbl_extend("force", opts, { desc = "Go to tab 2" }))
keymap("n", "<Leader>3", "3gt", vim.tbl_extend("force", opts, { desc = "Go to tab 3" }))
keymap("n", "<Leader>4", "4gt", vim.tbl_extend("force", opts, { desc = "Go to tab 4" }))
keymap("n", "<Leader>5", "5gt", vim.tbl_extend("force", opts, { desc = "Go to tab 5" }))
...
-- ============================================================
-- Comments — remap gc/gcc to <leader>/
-- ============================================================
do
